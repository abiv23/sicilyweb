    ...
    <div class="min-h-screen bg-gray-50 py-8">
      <div class="container mx-auto px-6 max-w-6xl">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          <mat-card class="p-6 bg-blue-600 text-white shadow-xl">
          ...
          <mat-card class="p-6 bg-green-600 text-white shadow-xl">
          ...
          <mat-card class="p-6 bg-purple-600 text-white shadow-xl">
          ...
          <mat-card class="p-6 bg-red-600 text-white shadow-xl">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          @for (resource of learningResources; track resource.title) {
            <mat-card class="p-6 bg-white border border-gray-200 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
              ...
              <a [href]="resource.url" target="_blank" 
                 class="inline-block bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg font-semibold transition-all duration-300 no-underline">
                Start Learning →
              </a>
            </mat-card>
          }
        ...
        <mat-card class="p-8 bg-orange-50 border border-orange-200 mb-8 shadow-xl">
          <h3 class="text-2xl font-bold mb-4 text-orange-800">🏝️ Sicily-Specific Tips</h3>
          ...
          <p class="text-gray-700 leading-relaxed">
            <strong class="text-orange-800">Cultural note:</strong> Sicilians especially appreciate when visitors make an effort to speak Italian, 
        ...
        <mat-card class="p-8 bg-white border border-gray-200 shadow-xl border-l-4 border-l-orange-500 mb-8">
        ...
        <mat-card class="p-8 bg-green-600 text-white shadow-xl text-center">
